 ...
 * Format: { code: string, country: string, flag: string }
 * Sorted by country name for easy reference
 */
...
/**
 * Popular/commonly used country codes for quick access
 ...
 * @param {string} code - The country code (e.g., '+60')
...
/**
 * Get formatted display string for country code
 * @param {string} code - The country code (e.g., '+60')
 * @returns {string} - Formatted string like "🇲🇾 +60"
 */
